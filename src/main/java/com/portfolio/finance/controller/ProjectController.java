...
public class ProjectController {
    ...
    @GetMapping("/{id}") public String detail(@PathVariable Long id, Model model) { model.addAttribute("project", service.findById(id)); model.addAttribute("evaluation", service.evaluate(id)); model.addAttribute("evaluationHistory", service.findRecentSnapshots(id)); return "projects/detail"; }
