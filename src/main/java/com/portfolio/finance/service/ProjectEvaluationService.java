...
public class ProjectEvaluationService {
    ...
    public ProjectEvaluationService(EvaluationProjectRepository repository, FinancialCalculationEngine calculationEngine) {
        this.repository = repository; this.calculationEngine = calculationEngine;
    }
    ...
    public ProjectEvaluationResponse evaluate(Long projectId) {
        ...
        return new ProjectEvaluationResponse(project.getId(), project.getName(), npv, irr, payback, riskScore, varEstimate,
                calculationEngine.grade(npv, irr, riskScore),
